  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-purple-50 to-white flex justify-center items-center">
        <div className="bg-white w-64 h-32 rounded-xl animate-pulse shadow"></div>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-50 to-white p-6">
      ...
      <div className="max-w-xl mx-auto">
        ...
        {/* CARD */}
        <div className="bg-white p-8 rounded-2xl shadow-md border border-purple-100 space-y-5">
          ...
          {/* HELP OFFER */}
          <textarea
            className="w-full p-3 rounded-lg border outline-none focus:ring-2 focus:ring-purple-500 focus:border-purple-500 h-28"
            value={helpOffer}
