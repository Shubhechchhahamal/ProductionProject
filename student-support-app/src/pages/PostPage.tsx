...
export default function PostPage() {
  ...
  return (
    <motion.div
      ...
      className="min-h-screen bg-gradient-to-br from-purple-50 to-white py-10 px-6"
    >
      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="bg-white p-6 rounded-2xl shadow-md border border-purple-100 mb-6">
          ...
          <div className="flex justify-between items-start">
            ...
            <div className="relative">
              ...
              {activeMenu === "post" && (isOwner || isAdmin) && (
                <div className="absolute right-0 mt-2 bg-white shadow-lg rounded-lg w-36 border">
                  {isOwner && (
                    <button
                      onClick={() => {
                        setIsEditing(true);
          ...
          <p
            ...
            className="text-sm font-semibold cursor-pointer mt-2 hover:underline"
          >
            {post.userName}
          ...
          {isEditing ? (
            <div className="space-y-3 mt-3">
              ...
              <div className="flex gap-2">
                <button onClick={handleUpdatePost} className="bg-purple-600 text-white px-4 py-2 rounded">
                  Save
                </button>
        ...
        <div className="bg-white p-6 rounded-2xl shadow-md border border-purple-100">
          ...
          {replies.map((r) => {
            ...
            return (
              <div
                key={r.id}
                className="bg-purple-50 p-3 rounded-lg mb-3 flex justify-between border border-purple-100"
              >
                <div>
                  <p
